...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var guessTheNumber = new Random().Next(101);
            ...
            while (guess != guessTheNumber)
            {
                ...
                if (input == "cheat")
                {
                    ...
                    Console.WriteLine($"Shhhh... I'm thinking of {guessTheNumber}");
                ...
                if (input == "change")
                {
                    ...
                    guessTheNumber = new Random().Next(101);

                    // And as they know the secret command, tell them the new number
                    Console.WriteLine($"Shhhh... I'm now thinking of {guessTheNumber}");
                ...
                if (int.TryParse(input, out guess))
                {
                    ...
                    {
                        // Congratulate them
                        Console.WriteLine($"Good Job!!! You guessed right. I was thinking of {guessTheNumber}");
                    ...
                    else
                    {
                        ...
                        Console.WriteLine($"Not quite. I'm thinking of a number that is { (guess > guessTheNumber ? "lower" : "higher") }");
                    }
                }
                // Otherwise...
                else
